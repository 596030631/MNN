...
public class RtspVideoActivity extends AppCompatActivity implements AdapterView.OnItemSelectedListener {
    ...
    private static final String TAG = "RtspVideoActivity";
    private final int MAX_CLZ_SIZE = 1000;

    private static final String MobileModelFileName = "MobileNet/v2/mobilenet_v2.caffe.mnn";
    private static final String MobileWordsFileName = "MobileNet/synset_words.txt";

    private static final String SqueezeModelFileName = "SqueezeNet/v1.1/squeezenet_v1.1.caffe.mnn";
    private static final String SqueezeWordsFileName = "SqueezeNet/squeezenet.txt";
...
//                    "rtsp://admin:123456@58.56.152.66:8073/cam/realmonitor?channel=1&subtype=1"
        ...
        mForwardTypeSpinner.setOnItemSelectedListener(RtspVideoActivity.this);
        mThreadNumSpinner.setOnItemSelectedListener(RtspVideoActivity.this);
        mModelSpinner.setOnItemSelectedListener(RtspVideoActivity.this);
        mMoreDemoSpinner.setOnItemSelectedListener(RtspVideoActivity.this);
...
//        });
    ...
    public void onItemSelected(AdapterView<?> adapterView, View view, int i, long l) {
        ...
        // model index
            ...
            if (i == 1) {
                Intent intent = new Intent(RtspVideoActivity.this, ImageActivity.class);
                startActivity(intent);
            } else if (i == 2) {
                Intent intent = new Intent(RtspVideoActivity.this, PortraitActivity.class);
                startActivity(intent);
            } else if (i == 3) {
                Intent intent = new Intent(RtspVideoActivity.this, OpenGLTestActivity.class);
                startActivity(intent);
            }
        }
